  ...
  return (
    <div className="min-h-screen bg-[#0a051b] flex items-center justify-center p-4 py-12 overflow-y-auto">
      <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="text-center p-8 bg-slate-900/50 rounded-3xl border border-white/10 backdrop-blur-xl shadow-2xl max-w-3xl w-full mx-auto">
        ...
        <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6">Training Successfully Completed!</h2>
        
        <div className="text-slate-300 text-base sm:text-lg mb-8 max-w-2xl mx-auto space-y-4 leading-relaxed">
          ...
          <p className="text-slate-400 italic">— Organic Mushroom Farm</p>
        </div>
        ...
        {isGenerating ? (
          ...
          <div className="flex flex-col items-center gap-6">
            ...
            <div className="mt-8 pt-8 border-t border-white/10 flex flex-col sm:flex-row items-center justify-center gap-6">
                <a href="https://wa.me/919203544140" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-slate-300 hover:text-green-400 transition-colors">
                    <MessageCircle className="w-5 h-5" />
                    <span>WhatsApp Support (9203544140)</span>
                </a>
                <a href="https://organicmushroomsfarm.com" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-slate-300 hover:text-indigo-400 transition-colors">
